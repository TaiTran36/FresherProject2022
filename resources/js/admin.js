                ...
                success: function (data) {
                    ...
                    '<td>' + 
                        ...
                        '<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">' + 
                            '<a href="javascript:void(0)" id="edit-category" data-id="' + category['id'] + '" class="dropdown-item">' + 
                                'Edit' + 
                            '</a>' + 

                            '<a href="javascript:void(0)" id="delete-category" data-id="' + category['id'] + '" class="dropdown-item delete-category">' + 
                                'Delete' + 
                            '</a>' + 
                        '</div>' + 
                    '</td></tr>';
