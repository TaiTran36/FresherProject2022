...
<div class="page-header"><h4>Edit Post</h4></div>
...
<div class="col-xs-4 col-xs-offset-4">
	...
	<form action="{{ url('/post/update') }}" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="name" name="url" placeholder="url" value="{{ $getpostById[0]->url }}" required />
		</div>
		<div class="form-group">
			<label for="content">Content</label>
			<input type="text" class="form-control" id="name" name="content" placeholder="content" value="{{ $getpostById[0]->content }}" required />
		</div>
