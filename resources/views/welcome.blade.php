...
<html lang="en">
  ...
  <body>
      ...
      <div class="container"> 
        <div class="parent">
          <div class="md:flex py-5">
            <div class="md:w-1/2 w-full logo md:order-2 text-center "><a class="text-black text-xl font-bold" href="../index.html">MAGDESIGN </a></div>
    ...
    <!--slider-->
    <div class="parent">
      <h1 class="mt-16 text-center text-4xl font-extrabold tracking-wide ">Trending</h1>
            ...
            <ul class="splide__list">
              <li class="splide__slide">
                <div class="son lg:flex">
                  <div class="pic w-full lg:w-1/3 md:mr-10 "><img class="w-full rounded-md" src="../assets/slider1/post_lg_1.jpg"></div>
                  <!--content-->
                  <div class="content w-full lg:w-2/3 mt-8">
                    ...
                    <h2 class="mt-6 mb-3 text-4xl font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
                    <p class="text-gray-500 mt-2 text-md leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><a class="flex mt-8 " href="#">
                      <div class="author-pic w-16 mr-5"><img class="rounded-full" src="../assets/slider1/person_1.jpg"></div>
                      <div class="author-info mt-2"><strong class="block text-sm">Sergy Campbell</strong><span class="text-xs font-light text-gray-500">CEO and Founder</span></div></a>
                  </div>
                </div>
              </li>
              <li class="splide__slide">
                <div class="son lg:flex">
                  <div class="pic w-full lg:w-1/3 md:mr-10 "><img class="w-full rounded-md" src="../assets/slider1/post_lg_2.jpg"></div>
                  <!--content-->
                  <div class="content w-full lg:w-2/3 mt-8">
                    <div class="top text-sm"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
                    <h2 class="mt-6 mb-3 text-4xl font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
              ...
              <li class="splide__slide">
                <div class="son lg:flex">
                  <div class="pic w-full lg:w-1/3 md:mr-10 "><img class="w-full rounded-md" src="../assets/slider1/post_lg_3.jpg"></div>
                  <!--content-->
                  <div class="content w-full lg:w-2/3 mt-8">
                    <div class="top text-sm"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
                    <h2 class="mt-6 mb-3 text-4xl font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
              ...
              <li class="splide__slide">
                <div class="son lg:flex">
                  <div class="pic w-full lg:w-1/3 md:mr-10 "><img class="w-full rounded-md" src="../assets/slider1/post_lg_4.jpg"></div>
                  <!--content-->
                  <div class="content w-full lg:w-2/3 mt-8">
                    <div class="top text-sm"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
                    <h2 class="mt-6 mb-3 text-4xl font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
    ...
    <!--main cards-->
    <div class="container md:flex flex-wrap justify-between">
      <div class="main_cards my-10">
        <div class="pic"><a href="../pug_files/related.html"> <img class="w-full rounded-md" src="../assets/home_cards/img_2.jpg"></a></div>
        <div class="content">
          <div class="top text-sm mt-10"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
          <h2 class="mt-3 mb-3 text-lg font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
          <p class="text-gray-500 mt-2 text-sm leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><a class="flex mt-10 " href="#">
            <div class="author-pic w-16 mr-5"><img class="rounded-full" src="../assets/slider1/person_1.jpg"></div>
            <div class="author-info mt-2"><strong class="block text-sm">Sergy Campbell</strong><span class="text-xs font-light text-gray-500">CEO and Founder</span></div></a>
        </div>
      </div>
      <div class="main_cards my-10">
        <div class="pic"><a href="../pug_files/related.html"> <img class="w-full rounded-md" src="../assets/home_cards/img_3.jpg"></a></div>
        <div class="content">
          <div class="top text-sm mt-10"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
          <h2 class="mt-3 mb-3 text-lg font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
          <p class="text-gray-500 mt-2 text-sm leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><a class="flex mt-10 " href="#">
      ...
      <div class="main_cards my-10">
        <div class="pic"><a href="../pug_files/related.html"> <img class="w-full rounded-md" src="../assets/home_cards/img_4.jpg"></a></div>
        <div class="content">
          <div class="top text-sm mt-10"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
          <h2 class="mt-3 mb-3 text-lg font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
          <p class="text-gray-500 mt-2 text-sm leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><a class="flex mt-10 " href="#">
      ...
      <div class="main_cards my-10">
        <div class="pic"><a href="../pug_files/related.html"> <img class="w-full rounded-md" src="../assets/home_cards/img_5.jpg"></a></div>
        <div class="content">
          <div class="top text-sm mt-10"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
          <h2 class="mt-3 mb-3 text-lg font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
          <p class="text-gray-500 mt-2 text-sm leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><a class="flex mt-10 " href="#">
      ...
      <div class="main_cards my-10">
        <div class="pic"><a href="../pug_files/related.html"> <img class="w-full rounded-md" src="../assets/home_cards/img_6.jpg"></a></div>
        <div class="content">
          <div class="top text-sm mt-10"><a class="font-bold" href="#">Business, Travel </a><span class="text-gray-400">- July 2,2020</span></div>
          <h2 class="mt-3 mb-3 text-lg font-extrabold leading-sung tracking-wide"><a href="../pug_files/related.html"> Your most unhappy customers are your greatest source of learning.</a></h2>
          <p class="text-gray-500 mt-2 text-sm leading-sung tracking-wide">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><a class="flex mt-10 " href="#">
    ...
    <div class=" container lg:flex block">
      <div class="block my-28">
        <h1 class="text-2xl font-extrabold mb-0">Sports</h1>
        <!--Bussiness cards-->
        <div class="parent ">
      ...
      <div class="block my-28">
        <h1 class="text-2xl font-extrabold">Business</h1>
        <!--Bussiness cards-->
        <div class="parent ">
          <div class="business_cards md:flex block my-12">
            <div class="pic md:w-80 w-full md:mb-0 mb-6 mr-3"><img class="w-full rounded-md " src="../assets/home_cards/img_2.jpg"></div>
    ...
    <script src="{{asset('home/plugin.js')}}"> </script><script>new Splide( '.splide' ).mount();</script>
  </body>
</html>