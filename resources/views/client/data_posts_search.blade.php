@foreach ($listpost as $post)
    ...
    <div class="parent">
        <div class="business_cards md:flex block my-12">
            <div class="md:w-80 w-full md:mb-0 mb-6 mr-3"><img class="w-full rounded-md " style="width:280px;height:180px"
            ...
            <div class="content" style="width:800px;height:150px">
                ...
                <p class="text-gray-500 mt-2 text-md leading-sung tracking-wide"
                    ...
                    <a href="/author/{{ $post->writer_username }}/posts">
                        ...
                        <div class="author-info mt-2"><strong class="block text-sm">{{ $post->writer_name }}</strong>
...
@endforeach
<br><br>
<div style="width:70%" id="pagination_search_posts">
    {{ $listpost->links('pagination::tailwind') }}
</div>
