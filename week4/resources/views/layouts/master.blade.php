...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('uploads/profiles/'.Auth::user()->avatar) }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
    ...
    <script src="{{asset('jquery.overlayScrollbars.min.js')}}"></script>
